...
class CronController extends ConstructController
{
    ...
    public function getDNSDomain(){
        ...
        GetDNSDomain::dispatch($getNoteDomain)->delay(now()->addMinutes(2));
    }
    public function ImportAffiliate(){
        $getJob=Jobs::where('type','datafeed')->first();
        //$getJob->value="sendo.vn";
        //$getJob->campaign="sendovn";
        //$getJob->total=3571018;
        //$getJob->page=1;
        //$getJob->page_limit=71420;
        //$getJob->save();
        //dd($getJob);
        //$client = new Client();
        //$response = $client->request('GET', 'https://api.accesstrade.vn/v1/datafeeds?domain=sendo.vn&page=1',
        //		[

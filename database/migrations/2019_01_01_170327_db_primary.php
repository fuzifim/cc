...
class DbPrimary extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('channel', function (Blueprint $table) {
            ...
            $table->integer('channel_parent_id')->default(0);
            $table->integer('user_id');
            $table->integer('service_attribute_id')->default(0);
            $table->integer('channel_view')->default(0);
            $table->integer('channel_currency')->default(0);
        ...
        Schema::create('domain', function (Blueprint $table) {
            ...
            $table->integer('user_id');
            $table->integer('domain_id_registrar')->default(0);
            $table->integer('service_attribute_id')->default(0);

				...
				if(result.success==false){
					if(result.error=='login'){
						...
						$('#myModal .modal-body').append('<div class="message"></div><div class="form-group"><div class="input-group">'
							...
							+'<input placeholder="Email hoặc điện thoại" id="email" name="email" type="text" class="form-default valid" value="" aria-required="true" aria-invalid="false">'
							+'</div></div>'
							+'<div class="form-group">'
								+'<div class="input-group">'
									+'<span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>'
									+'<input placeholder="Mật khẩu" id="password" type="password" name="password" class="form-default valid" aria-required="true" aria-invalid="false">'
								+'</div>'
							+'</div>'
							+'<div class="form-group">'
				...
				if(result.success==true){
					...
					$('#myModal .modal-body').append('<form id="formBuyNow">'
						+'<div class="form-group">'
							+'<div class="input-group">'
								+'<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span> '
								+'<input type="text" class="form-default" id="name" name="name" placeholder="Họ tên" value="'+result.dataBuyNow.userName+'" required="">'
							+'</div>'
						...
						+'<div class="form-group">'
							+'<div class="input-group">'
								...
								+'<input type="email" class="form-default" id="email" name="email" placeholder="Địa chỉ email" value="'+result.dataBuyNow.userEmail+'" required="">'
							+'</div>'
						...
						+'<div class="form-group">'
							+'<div class="input-group">'
								...
								+'<input type="phone" class="form-default" id="phone" name="phone" placeholder="Số điện thoại" value="'+result.dataBuyNow.userPhone+'" required="">'
							+'</div>'
						...
						+'<div class="form-group">'
							+'<div class="input-group">'
								...
								+'<input type="text" class="form-default" id="address" name="address" placeholder="Địa chỉ nhận hàng" value="'+result.dataBuyNow.userAddress+'" required="">'
							+'</div>'
						...
						+'<div class="form-group">'
							+'<div class="input-group">'
								...
								+'<input type="number" class="form-default" id="quanlity" name="quanlity" placeholder="Số lượng mua" value="1" required="">'
							+'</div>'
							+'<label class="error" for="quanlity"></label>'
						+'</div>'
						+'<div class="form-group">'
							+'<textarea class="form-default" type="textarea" id="content" name="content" placeholder="Ghi chú..." maxlength="140" rows="2"></textarea>'

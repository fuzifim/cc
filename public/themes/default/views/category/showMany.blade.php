				...
				$(".groupChannelName").on("click",".btnChannelNameEdit",function() {
					...
					changeChannelNameText.append("<form id=\"changeChannelName\">"
						+"<div class=\"form-group\">"
							+"<input type=\"phone\" style=\"font-size:18px;\" name=\"categoryName\" value=\""+categoryName+"\" class=\"form-default\" placeholder=\"Nhập tên danh mục...\" required /><input type=\"hidden\" name=\"categoryId\" value=\""+categoryId+"\"><input type=\"hidden\" name=\"parentId\" value=\""+parentId+"\">"
							+"<label class=\"error\" for=\"categoryName\"></label>"
						+"</div>"
						+"<div class=\"form-group\">"
							+"<textarea name=\"categoryDescription\" class=\"form-default\" placeholder=\"Mô tả danh mục...\">"+categoryDescription+"</textarea>"
						...
						+"</div>" 
						+"<div class=\"form-group\">"
							+"<input type=\"number\" name=\"categoryOrderBy\" value=\""+orderBy+"\" class=\"form-default\" placeholder=\"Số thứ tự sắp xếp\">"
					...
					$.ajax({
						...
						success: function (data) {
							$("#changeChannelName .addCategorySelect").append("<select class=\"form-default\" name=\"categoryParentId\" id=\"categoryParentId\">"+data+"</select>");
						}
					});

	...
	$channel['theme']->asset()->writeScript('custom',' 
		...
		$(".phoneItemGroup").on("click",".phoneChange",function() {
			...
			changePhoneItem.append("<div class=\"form-group\">"
				+"<div class=\"input-group\">"
					+"<span class=\"input-group-addon\"><i class=\"glyphicon glyphicon-earphone\"></i></span>"
					+"<input type=\"phone\" name=\"channelPhone\" value=\""+phoneAddress+"\" class=\"form-default\" placeholder=\"Nhập số điện thoại...\" required />"
				+"</div>"
		...
		$(".phoneItemGroup").on("click",".phoneAddNew",function() {
			...
			changePhoneItem.append("<div class=\"form-group\">"
				+"<div class=\"input-group\">"
					+"<span class=\"input-group-addon\"><i class=\"glyphicon glyphicon-earphone\"></i></span>"
					+"<input type=\"phone\" name=\"channelPhone\" value=\"\" class=\"form-default\" placeholder=\"Nhập số điện thoại...\" required />"
				+"</div>"
				+"<label class=\"error\" for=\"channelPhone\"></label></div>");
		...
		$(".emailItemGroup").on("click",".emailChange",function(){
			...
			changeEmailItem.append("<div class=\"form-group\">"
				+"<div class=\"input-group\">"
					...
					+"<input type=\"email\" name=\"channelEmail\" value=\""+emailAddress+"\" class=\"form-default\" placeholder=\"Nhập địa chỉ email...\" required />"
				+"</div>"
		...
		$(".emailItemGroup").on("click",".emailAddNew",function() {
			...
			changeEmailItem.append("<div class=\"form-group\">"
				+"<div class=\"input-group\">"
					+"<span class=\"input-group-addon\"><i class=\"fa fa-envelope-o\"></i></span>"
					+"<input type=\"email\" name=\"channelEmail\" value=\"\" class=\"form-default\" placeholder=\"Nhập địa chỉ email...\" required />"
				+"</div>"
				+"<label class=\"error\" for=\"channelEmail\"></label></div>");
		...
		$(".addressItemGroup").on("click",".addressAddNew",function() {
			...
			changeAddressItem.append("<div class=\"form-group\">"
				+"<div class=\"input-group\">"
					...
					+"<input type=\"text\" name=\"channelAddress\" value=\"\" class=\"form-default\" placeholder=\"Địa chỉ đường, số nhà công ty, cửa hàng...\" required />"
				+"</div>"
		...
		$(".addressItemGroup").on("click","#changeAddress",function() {
			...
			changeAddressItem.append("<div class=\"form-group\">"
				+"<div class=\"input-group\">"
					+"<span class=\"input-group-addon\"><i class=\"fa fa-map-marker\"></i></span>"
					+"<input type=\"text\" name=\"channelAddress\" value=\""+address+"\" class=\"form-default\" placeholder=\"Địa chỉ đường, số nhà công ty, cửa hàng...\" required />"
				+"</div>"
				+"<label class=\"error\" for=\"channelAddress\"></label></div>"); 

		...
		jQuery(document).ready(function(){
			...
			function getCheckDomain(){
				$(".panelNewRegisterDomain .checkDomain").append("<div class=\"form-group\"><div class=\"input-group\">"      
					+"<input type=\"text\" class=\"form-default\" name=\"domainNewRegister\" placeholder=\"Nhập tên miền đăng ký\">"
					+"<span class=\"input-group-btn\">"
				...
				$.ajax({
					...
					success: function (result) {
						...
						if(result.success==true){
							...
							$("#myModal .modal-body").append(""
								+"<div class=\"form-group\">"
									+"<label for=\"date_begin\" class=\"default-label\">Ngày đăng ký</label>"
									+"<div class=\"input-group\">"
										+"<span class=\"input-group-addon\" id=\"basic-addon1\"><i class=\"glyphicon glyphicon-calendar\"></i></span>"
										+"<input placeholder=\""+result.date_begin+"\" id=\"date_begin\" name=\"date_begin\" value=\""+result.date_begin+"\" type=\"text\" data-date-format=\"dd-mm-yyyy\" class=\"form-default datepicker\">"
									+"</div>"
								+"</div>"
								+"<div class=\"form-group\">"
									+"<label for=\"date_end\" class=\"default-label\">Ngày Hết hạn</label>"
									+"<div class=\"input-group\">"
										+"<span class=\"input-group-addon\" id=\"basic-addon1\"><i class=\"glyphicon glyphicon-calendar\"></i></span>"
										+"<input placeholder=\""+result.date_end+"\" id=\"date_end\" name=\"date_end\" value=\""+result.date_end+"\" type=\"text\" data-date-format=\"dd-mm-yyyy\" class=\"form-default datepicker\">"
									+"</div>"
								+"</div>"
								+"<div class=\"form-group\">"
									+"<label for=\"domainLocation\" class=\"default-label\">Vị trí tên miền</label>"
									+"<div class=\"input-group\">"
								...
								+"</div>"
								+"<div class=\"form-group\">"
									+"<label for=\"domainStatus\" class=\"default-label\">Tình trạng</label>"
									+"<div class=\"input-group\">"
										+"<div class=\"checkbox text-primary\">"

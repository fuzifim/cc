		...
		jQuery(document).ready(function(){
			...
			$(".btnKeyReSearch").click(function(){
				...
				if($(".appendKeyWords .addInput").length<=0){
					$(".appendKeyWords").append("<div class=\"form-group addInput\"><div class=\"input-group\"><input type=\"text\" value=\""+postTitle+"\" name=\"inputKeyword\" class=\"form-default\"><span class=\"input-group-btn\"><button type=\"button\" class=\"btn btn-primary\"><i class=\"glyphicon glyphicon-search\"></i> <span class=\"hidden-xs\">lấy ý tưởng</span></button></span></div></div>");
				}
				var inputKeyword=$(".appendKeyWords input[name=inputKeyword]").val(); 
				if(inputKeyword.length) { 
					$(".appendKeyWords").append("<div class=\"addKeyWord\"></div>"); 
					 $.ajax({
						...
						success: function(result){
							...
							$(".appendKeyWords .addKeyWord").append("<div class=\"form-group\"><input name=\"tags\" id=\"tags\" class=\"form-default\" value=\""+result[1].toString()+"\" /></div>");
			...
			$("#btnAddNewCategoryPost").click(function(){
				...
				$.ajax({
					...
					success: function (data) {
						...
						$(".addNewCategoryElementPost #addCategoryForm").append("<div class=\"form-group\"><select class=\"form-default\" name=\"categoryParentId\" id=\"categoryParentId\">"+data+"</select></div>");
				...
				if(attributePrice.length <= 0){
					...
					+"<div class=\"form-group\" id=\"attributePrice\">"
						...
						+"<div class=\"input-group\">"
							...
							+"<input type=\"number\" name=\"attributePrice\" class=\"form-default\" value=\"\" placeholder=\"Vd: 500000\">"

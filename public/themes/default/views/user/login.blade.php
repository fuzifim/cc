	...
	<div class="contentpanel">
		<form class="form-login mainbox" style="">
			<div class="form-group">
				<a href="{{route('index',$channel['domain'])}}"><i class="glyphicon glyphicon-chevron-left"></i> Trở về {{$channel['info']->channel_name}}</a>
			</div>
			<div class="panel panel-default">
				...
				<div class="panel-body" >
					...
					<div class="form-group">
						<a href=""><i class="glyphicon glyphicon-lock"></i> Quên mật khẩu</a> | <a href="{{route('register',$channel['domain'])}}"><i class="glyphicon glyphicon-ok-sign"></i> Đăng ký</a>
					</div>
					<div class="form-group">

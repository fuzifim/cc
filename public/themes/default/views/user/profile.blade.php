	...
	$channel['theme']->asset()->writeScript('custom','
		...
		$("#changePassword").click(function(){
			...
			$("#myModal .modal-body").append(""
				+"<div class=\"form-group\">"
					+"<label for=\"password\" class=\"default-label\">Mật khẩu cũ</label>"
					+"<div class=\"input-group\">"
						+"<span class=\"input-group-addon\"><i class=\"glyphicon glyphicon-lock\"></i></span>"
						+"<input placeholder=\"Mật khẩu cũ\" id=\"password\" name=\"password\" value=\"\" type=\"password\" class=\"form-default\">"
					+"</div>"
				+"</div>"
				+"<div class=\"form-group\">"
					+"<label for=\"passwordNew\" class=\"default-label\">Mật khẩu mới</label>"
					+"<div class=\"input-group\">"
						+"<span class=\"input-group-addon\"><i class=\"glyphicon glyphicon-lock\"></i></span>"
						+"<input placeholder=\"Mật khẩu mới\" id=\"passwordNew\" name=\"passwordNew\" value=\"\" type=\"password\" class=\"form-default\">"
					+"</div>"
				+"</div>"
			+""); 
		...
		$("#profileBank").click(function(){
			...
			$.ajax({
				...
				success:function(result){
					...
					+"<div class=\"form-group\">"
						+"<label for=\"bankName\" class=\"default-label\">Tên tài khoản</label>"
						+"<input class=\"form-default\" type=\"text\" id=\"bankName\" name=\"bank[]\" data-type=\"bankName\" value=\""+result.bank.bankName+"\" placeholder=\"Tên tài khoản\">"
					+"</div>"
					+"<div class=\"form-group\">"
						+"<label for=\"bankNumber\" class=\"default-label\">Số tài khoản</label>"
						+"<input class=\"form-default\" type=\"text\" id=\"bankNumber\" name=\"bank[]\"  data-type=\"bankNumber\" value=\""+result.bank.bankNumber+"\" placeholder=\"Số tài khoản\">"
					+"</div>"
					+"<div class=\"form-group\">"
						+"<label for=\"bankCompany\" class=\"default-label\">Ngân hàng</label>"
						+"<input class=\"form-default\" type=\"text\" id=\"bankCompany\" name=\"bank[]\"  data-type=\"bankCompany\" value=\""+result.bank.bankCompany+"\" placeholder=\"Tên ngân hàng\">"
					+"</div>"
					+"<div class=\"form-group\">"
						+"<label for=\"bankRegion\" class=\"default-label\">Chi nhánh/ Khu vực</label>"
						+"<input class=\"form-default\" type=\"text\" id=\"bankRegion\" name=\"bank[]\"  data-type=\"bankRegion\" value=\""+result.bank.bankRegion+"\" placeholder=\"Chi nhánh/ Khu vực\">"
					+"</div>"
					+""); 
